...
var onBobRegistration = async (runtime2, payload) => {
  ...
  runtime2.log(`\uD83D\uDC64 Processing registration for: ${data.registrant}`);
  ...
  runtime2.log(`✅ Transaction Success! Tx Hash: ${txHash}`);
  runtime2.log(`\uD83D\uDCBE [Mock DB] Rules Saved: Requires WorldID = ${data.rules.requiresWorldID}`);
